...
create or replace view PRIVATE_PATIENT_DIMENSION
as 
select 
    dim.* ,
...
from DEIDENTIFIED_PCORNET_CDM.CDM_2023_JULY.DEID_DEMOGRAPHIC as dim
inner join I2B2_PCORNET_CDM.CDM_2023_JULY.PATIENT_CROSSWALK as pc
using(patid)
left join DEIDENTIFIED_PCORNET_CDM.CDM_2023_JULY.DEID_DEATH as dead  
using (patid);
