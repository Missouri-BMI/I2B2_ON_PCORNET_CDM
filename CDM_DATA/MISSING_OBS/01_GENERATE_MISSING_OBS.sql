...
use schema report;
CREATE OR REPLACE TABLE I2B2METADATA.GENERAL_OBSERVATIONS (
...
DELETE FROM I2B2METADATA.TABLE_ACCESS WHERE C_TABLE_NAME = 'GENERAL_OBSERVATIONS';
DELETE FROM I2B2DATA.concept_dimension WHERE CONCEPT_PATH LIKE '%GENERAL OBSERVATIONS%';
...
insert into i2b2metadata.GENERAL_OBSERVATIONS (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE,
