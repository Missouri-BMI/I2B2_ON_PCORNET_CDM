...
select fact.*,
     ...
     LAB_ORDER_DATE  :: TIMESTAMP                 AS I2B2_START_DATE,
       concat('LOINC:', LAB_LOINC)                as I2B2_CONCEPT_CD,
       '@'                                       as I2B2_PROVIDER_ID,
     ...
     END                                  as I2B2_TVAL_CHAR,
       cast(RESULT_NUM as DECIMAL(18, 5)) as I2B2_NVAL_NUM,
       cast('' as VARCHAR(50))            as I2B2_VALUEFLAG_CD,
       cast(null as DECIMAL(18, 5))       as I2B2_QUANTITY_NUM,
       cast(RESULT_UNIT as VARCHAR(50))   as I2B2_UNITS_CD,
...
select fact.*,
     ...
     LAB_ORDER_DATE  :: TIMESTAMP       AS I2B2_START_DATE,
       ...
       cast(RESULT_QUAL as VARCHAR(255)) as I2B2_TVAL_CHAR,
