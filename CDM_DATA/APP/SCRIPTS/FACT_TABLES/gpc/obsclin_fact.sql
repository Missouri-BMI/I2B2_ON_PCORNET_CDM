...
select fact.*,
    ...
    obsclin_start_date   as I2B2_START_DATE,
    ...
    -- TO_TIMESTAMP(COALESCE(fact.obsclin_stop_date, fact.obsclin_start_date) :: DATE || ' ' || COALESCE(fact.obsclin_stop_time, '00:00:00'), 'YYYY-MM-DD HH24:MI:SS') AS I2B2_END_DATE,
    obsclin_stop_date   AS I2B2_END_DATE,
...
select fact.*,
    ...
    '@'                              as I2B2_PROVIDER_ID,
    -- TO_TIMESTAMP(obsclin_start_date   :: DATE || ' ' || obsclin_start_time, 'YYYY-MM-DD HH24:MI:SS') as I2B2_START_DATE,
    obsclin_start_date :: TIMESTAMP   as I2B2_START_DATE,
    cast('@' as VARCHAR(100))         as I2B2_MODIFIER_CD,
    cast(1 as integer)                as I2B2_INSTANCE_NUM,
    ...
    cast(OBSCLIN_RESULT_UNIT as VARCHAR(50))  as I2B2_UNITS_CD,
    -- TO_TIMESTAMP(COALESCE(fact.obsclin_stop_date, fact.obsclin_start_date) :: DATE || ' ' || COALESCE(fact.obsclin_stop_time, '00:00:00'), 'YYYY-MM-DD HH24:MI:SS') AS I2B2_END_DATE,
    obsclin_stop_date :: TIMESTAMP  AS I2B2_END_DATE,
    cast('@' as VARCHAR(50))          as I2B2_LOCATION_CD,
    cast('' as TEXT)                  as I2B2_OBSERVATION_BLOB,
    cast(null as DECIMAL(18, 5))      as I2B2_CONFIDENCE_NUM,
    cast(null as TIMESTAMP)           as I2B2_UPDATE_DATE,
