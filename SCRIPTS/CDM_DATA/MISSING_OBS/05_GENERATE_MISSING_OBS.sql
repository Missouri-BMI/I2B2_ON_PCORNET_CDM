-- CRC SCHEMA IS HARD CODED TO {crc_schema}
-- ONT SCHEMA IS HARD CODED TO {metadata_schema}
-- ONTOLOGY TABLE NAME IS HARD CODED TO 'MISCELLANEOUS_OBSERVATIONS' AND DISPLAY NAME TO 'MISCELLANEOUS OBSERVATIONS'
use schema report;

DROP TABLE IF EXISTS {metadata_schema}.GENERAL_OBSERVATIONS;

CREATE OR REPLACE TABLE {metadata_schema}.MISCELLANEOUS_OBSERVATIONS (
...
DELETE FROM {metadata_schema}.TABLE_ACCESS WHERE C_TABLE_NAME = 'GENERAL_OBSERVATIONS' or C_TABLE_NAME = 'MISCELLANEOUS_OBSERVATIONS';
DELETE FROM {crc_schema}.concept_dimension WHERE CONCEPT_PATH LIKE '%GENERAL OBSERVATIONS%' or CONCEPT_PATH LIKE '%MISCELLANEOUS OBSERVATIONS%';
...
insert into {metadata_schema}.MISCELLANEOUS_OBSERVATIONS (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE,
