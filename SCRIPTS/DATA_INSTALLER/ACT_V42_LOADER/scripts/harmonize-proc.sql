...
BEGIN
    ...
    -- table_name in csv table access has _ORACLE suffix
    EXECUTE IMMEDIATE 'UPDATE table_access SET c_table_name = split_part(c_table_name, ''_ORACLE'', 1) WHERE c_table_name LIKE ''%_ORACLE''';
    ...
    for record in cur do
        ...
        case (ont_table_cd)
            ...
            when 'ACT_ZIPCODE' then fact_table_column := 'concept_cd';
